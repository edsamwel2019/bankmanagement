...
public class WithdrawalClass extends JFrame implements ActionListener{
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    ResultSet rs = c1.stmnt.executeQuery(" select * from bank where pin = '"+b+"' ");
