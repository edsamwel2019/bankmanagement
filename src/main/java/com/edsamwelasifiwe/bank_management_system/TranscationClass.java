...
public class TranscationClass extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){ 
            ...
            new Depositing().setVisible(true);
            setVisible(false);
            ...
            new FastCashAccess().setVisible(true);
            setVisible(false);
            ...
            try {
                ...
                ResultSet rs = c1.stmnt.executeQuery(" SELECT balance FROM bank ORDER BY pin  = '"+pinn+"' DESC LIMIT 1");
    ...
    public static void main(String[] args){
        new TranscationClass().setVisible(true);
    }
}
